...
export class SetpwdComponent implements OnInit {
  ...
  constructor(private httpService: HttpService, private nzModalService: NzModalService, private hdStateService: HdStateService, private rouer: Router, private route: ActivatedRoute) { }
